...
void InitGen()
{
	...
	//HW::PIOA->PINCFG[16] = 1;
	HW::PIOA->SetWRCONFIG(1<<16, PORT_PMUX(4)|PORT_WRPINCFG|PORT_PMUXEN|PORT_WRPMUX);

	//HW::PIOA->PINCFG[24] = 1;
	//HW::PIOA->PINCFG[25] = 1;
	//HW::PIOA->SetPinMux(24, 0);
	//HW::PIOA->SetPinMux(25, 0);
	HW::PIOA->SetWRCONFIG((1<<24)|(1<<25), PORT_PMUX(0)|PORT_WRPINCFG|PORT_PMUXEN|PORT_WRPMUX);
